...
(* OASIS_START *)
(* DO NOT EDIT (digest: 1350dcb7734143902b0161e2a54a9bcb) *)
(*
...
let setup_t =
  {
     ...
     package =
       {
          ...
          homepage = Some "https://github.com/tizoc/ppx-pgsql";
          bugreports = None;
               ...
               Library
                 ({
                   ...
                   },
                   {
                      ...
                      lib_findlib_name = Some "ppx_pgsql";
     ...
     oasis_version = "0.4.8";
     oasis_digest = Some "\002\235g-\026\179jx\025;\242>\207\021\155\024";
     oasis_exec = None;
     oasis_setup_args = [];
     setup_update = false
  };;
