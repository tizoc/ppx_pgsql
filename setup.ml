...
(* OASIS_START *)
(* DO NOT EDIT (digest: 0408a27d0b0e68a7ca3ef29046fe45df) *)
(*
...
let setup_t =
  {
     ...
     package =
       {
          ...
          homepage = Some "https://github.com/tizoc/ppx_pgsql";
          bugreports = None;
     ...
     oasis_version = "0.4.8";
     oasis_digest = Some "%-FZ\186\148g\154/\141\2523\005\192\150\165";
     oasis_exec = None;
     oasis_setup_args = [];
     setup_update = false
  };;
